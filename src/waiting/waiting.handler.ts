...
//   lpush(token: string): Promise<WaitingToken>;
// }

// @Injectable()
// export class WaitingManager implements Command {
...
//   isInTask(token: string): Promise<WaitingToken>;
//   isInWaiting(token: string): Promise<WaitingToken | false>;
// }

// @Injectable()
// export class WaitingReader implements Query {
//   constructor(
